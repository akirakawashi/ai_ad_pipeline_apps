...
DATA_YAML = PROJECT_ROOT / "ml/data/detection/yolo/ad_surface_full_v1_finetune_cvat_corrections/data.yaml"
MODEL_SOURCE = PROJECT_ROOT / "models/detection/trained/yolo11m_pretrained_img960_b10_antifp_full_v1/best.pt"
RUN_PROJECT = PROJECT_ROOT / "ml/runs/detection/detect/ad_surface_full_v1_finetune_cvat_corrections"
RUN_NAME = "yolo11m_img960_antifp_cvat_corrections_ft_v1"
EXPORT_DIR = PROJECT_ROOT / "models/detection/trained/yolo11m_img960_antifp_cvat_corrections_ft_v1"
