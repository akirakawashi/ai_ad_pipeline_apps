...
MODEL_SOURCE = PROJECT_ROOT / "models/detection/pretrained/yolo11m.pt"
RUN_PROJECT = PROJECT_ROOT / "ml/runs/detection/detect/ad_surface_full_v1"
RUN_NAME = "yolo11m_pretrained_img1280_b6_full_v1"
EXPORT_DIR = PROJECT_ROOT / "models/detection/trained/yolo11m_pretrained_img1280_b6_full_v1"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train YOLO11m pretrained baseline on ad_surface_full_v1.")
    ...
    parser.add_argument("--batch", type=parse_batch, default=6)
...
def main() -> None:
    ...
    config = {
        "hypothesis": "YOLO11m pretrained, balanced baseline",
        "data": str(data_yaml),
