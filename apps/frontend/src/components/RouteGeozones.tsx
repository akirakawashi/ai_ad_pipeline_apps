      ...
      {expanded && (
        <div className="geozone-body">
          <p className="geozone-hint">
            {sourceUrl
              ? 'Границы — доли проезда: 0 % — старт маршрута, 100 % — финиш. Смотрите видео и отмечайте кнопками ниже — проценты подставятся сами, набирать их руками не обязательно. Разметка принадлежит маршруту и применится ко всем его съёмкам.'
              : 'Границы — доли проезда: 0 % — старт маршрута, 100 % — финиш. Разметка принадлежит маршруту и применяется ко всем его съёмкам, включая будущие, — видео для этого не нужно.'}
          </p>
